            ...
            <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="active open">
                        <a href="#" class="dropdown-toggle">
                            <i class="menu-icon fa fa-list"></i>
                            <span class="menu-text"> 业务管理管理 </span>
                ...
                <div class="footer-inner">
                    <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">在线视频</span>
							&nbsp;&nbsp;&nbsp; &copy;king_leng
						</span>

                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="action-buttons">
							<a href="https://github.com/leng-xu/course.git">
								<p>Github 项目地址</p>
							</a>
						</span>
                    </div>
...
<script>
    export default {
        ...
        methods:{
            /**
             * 激活菜单的样式，id 是当前点击菜单的 id
             */
            activeSidebar (id) {
                // 兄弟菜单去掉 active 样式，自身增加 active 样式, siblings: jQuery的方法，获取兄弟节点
                $("#" + id).siblings().removeClass("active");
                $("#" + id).siblings().find("li").removeClass("active");
                $("#" + id).addClass("active");

                // 如果有父菜单，父菜单的兄弟菜单去掉 open active ，父菜单增加 open active
